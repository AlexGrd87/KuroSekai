...
export const DAILY_QUESTS = [
  ...
  },
  {
    ...
    icon: '闘',
    name: 'Duel du Jour',
    desc: 'Gagner 1 combat d\'arène',
    target: 1,
    rewards: { currency: 400 },
  },
  {
    id: 'daily_boss_strike',
    type: 'BOSS_FIGHT',
    icon: '魔',
    name: 'Assaut Nocturne',
    desc: 'Attaquer le Boss Hebdomadaire',
    target: 1,
    rewards: { currency: 350 },
  },
];
...
export const WEEKLY_QUESTS = [
  ...
  },
  {
    ...
    type: 'ARENA_WIN',
    icon: '闘',
    name: 'Champion de l\'Arène',
    desc: 'Gagner 5 combats d\'arène',
    target: 5,
    rewards: { currency: 2000, freeRolls: 1 },
  },
  {
    id: 'weekly_dungeon_1',
    type: 'DUNGEON_CLEAR',
    icon: '奈',
    name: 'Conquête Abyssale',
    desc: 'Compléter le Donjon Abyssal en entier',
    target: 1,
    rewards: { currency: 3000, freeRolls: 2 },
  },
  {
    id: 'weekly_boss_3',
    type: 'BOSS_FIGHT',
    ...
    desc: 'Frapper le Boss Hebdomadaire 3 fois',
    target: 3,
    rewards: { currency: 2500, freeRolls: 1 },
  },
];
